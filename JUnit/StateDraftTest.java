...
public class StateDraftTest extends JStateBaseTest {
    ...
    public void testHold() {
        i.hold();
        assertEquals("Draft.hold() should change the state to OpenDraft!", classOpenDraft, getState().getClass());
    }

    @Test
    public void testDecline() {
        i.decline();
        assertEquals("Draft.decline() should change the state to DeclinedIdea!", classDeclinedIdea, getState()
                .getClass());
    }
